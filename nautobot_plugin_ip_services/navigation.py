"""Navigation Items to add to Nautobot for nautobot_plugin_ip_services."""
...
menu_items = (
    PluginMenuItem(
        link='plugins:nautobot_plugin_ip_services:model',  # A reverse compatible link to follow.
        ...
        buttons = (  # Optional: Iterable of PluginMenuButton instances to display.
            PluginMenuButton(
                'plugins:nautobot_plugin_ip_services:model',  # A reverse compatible link to follow.
